...
export const CHARTS_CONFIG: Record<string, ChartConfig> = {
  revenue: {
    ...
    data: [
      ...
      { year: 2024, value: 245.1, growth: 16,  status: 'future' },
      { year: 2025, value: 282.0, growth: 15,  status: 'future' },
      { year: 2026, value: 328.0, growth: 16,  status: 'future' },
  ...
  ebitda: {
    ...
    data: [
      ...
      { year: 2024, value: 133.0, growth: 27,  status: 'future' },
      { year: 2025, value: 160.0, growth: 20,  status: 'future' },
      { year: 2026, value: 172.0, growth: 7,   status: 'future' },
    ...
    gradients: {
      past:   { top: '#81C784', bottom: '#A8E6CF' },
      future: { top: '#2E7D32', bottom: '#43A047' }
    },
    nav: {
  ...
  earnings: {
    ...
    data: [
      ...
      { year: 2024, value: 88.1, growth: 22,   status: 'future' },
      { year: 2025, value: 102,  growth: 16,   status: 'future' },
      { year: 2026, value: 120,  growth: 18,   status: 'future' },
  ...
  eps: {
    ...
    data: [
      ...
      { year: 2024, value: 13.6, growth: 17,  status: 'future' },
      { year: 2025, value: 16.5, growth: 21,  status: 'future' },
      { year: 2026, value: 19.0, growth: 15,  status: 'future' },
  ...
  'eps-basic': {
    ...
    data: [
      ...
      { year: 2024, value: 13.7, growth: 16,  status: 'future' },
      { year: 2025, value: 16.5, growth: 20,  status: 'future' },
      { year: 2026, value: 19.0, growth: 15,  status: 'future' },
      { year: 2027, value: 22.5, growth: 18,  status: 'future' },
      { year: 2028, value: 26.8, growth: 19,  status: 'future' },
      { year: 2029, value: 33.4, growth: 25,  status: 'future' }
  ...
  'quarterly-revenue': {
    ...
    data: [
      ...
      { year: 2026, value: 76.4, growth: 16,  status: 'future' },
  ...
  'gross-profit': {
    ...
    data: [
      ...
      { year: 2024, value: 171.0, growth: 15,  status: 'future' },
      { year: 2025, value: 200.0, growth: 17,  status: 'future' },
      { year: 2026, value: 235.0, growth: 18,  status: 'future' },
  ...
  'operating-income': {
    ...
    data: [
      ...
      { year: 2024, value: 109.4, growth: 24,  status: 'future' },
      { year: 2025, value: 130.0, growth: 19,  status: 'future' },
      { year: 2026, value: 155.0, growth: 19,  status: 'future' },
  ...
  'free-cash-flow': {
    ...
    data: [
      ...
      { year: 2024, value: 74.1,  growth: 13,  status: 'future' },
      { year: 2025, value: 89.0,  growth: 20,  status: 'future' },
      { year: 2026, value: 107.0, growth: 20,  status: 'future' },
  ...
  dividend: {
    ...
    data: [
      ...
      { year: 2024, value: 2.79, growth: 3,   status: 'future' },
      { year: 2025, value: 3.08, growth: 10,  status: 'future' },
      { year: 2026, value: 3.40, growth: 10,  status: 'future' },
  ...
  'rd-expense': {
    ...
    data: [
      ...
      { year: 2024, value: 29.5,  growth: 14,  status: 'future' },
      { year: 2025, value: 34.2,  growth: 16,  status: 'future' },
      { year: 2026, value: 39.7,  growth: 16,  status: 'future' },
  ...
  capex: {
    ...
    data: [
      ...
      { year: 2024, value: 44.5,  growth: 20,  status: 'future' },
      { year: 2025, value: 50.4,  growth: 13,  status: 'future' },
      { year: 2026, value: 55.0,  growth: 9,   status: 'future' },
  ...
  'net-debt': {
    ...
    data: [
      ...
      { year: 2024, value: 37.0,  growth: -12, status: 'future' },
      { year: 2025, value: 30.0,  growth: -19, status: 'future' },
      { year: 2026, value: 22.0,  growth: -27, status: 'future' },
